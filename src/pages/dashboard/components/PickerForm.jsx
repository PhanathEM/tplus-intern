...
// once that step has a selection, so the pickers show how far along you are
// without needing a separate stepper above the form.
...
export function SelectedCard({ icon: Icon, title, detail, onClear, t }) {
  return (
    <div className="flex items-center justify-between gap-3 rounded-lg border border-orange-200 bg-orange-50 px-3.5 py-2.5 dark:border-orange-800/60 dark:bg-orange-500/10">
      <div className="flex min-w-0 items-center gap-2.5">
        <span className="grid h-8 w-8 shrink-0 place-items-center rounded-lg bg-white text-orange-600 dark:bg-slate-900 dark:text-orange-400">
...
export function SummarySlot({ icon: Icon, label, title, detail, placeholder }) {
  if (!title) {
    return (
      <div className="flex items-center gap-2.5 rounded-lg border border-dashed border-slate-200 px-3 py-2.5 dark:border-slate-700">
        <span className="grid h-8 w-8 shrink-0 place-items-center rounded-lg bg-slate-50 text-slate-300 dark:bg-slate-800 dark:text-slate-600">
          <Icon size={14} className="block" />
        </span>
  ...
  return (
    <div className="flex items-center gap-2.5 rounded-lg bg-slate-50 px-3 py-2.5 dark:bg-slate-800/60">
      <span className="grid h-8 w-8 shrink-0 place-items-center rounded-lg bg-white text-slate-600 dark:bg-slate-900 dark:text-slate-300">
        <Icon size={14} className="block" />
      </span>
      <div className="min-w-0">
